			...
			<c:forEach items="${lsUser}" var="acc">
				<tr>
					...
					<td>
						...
						data-bs-target="#staticBackdrop${acc.id}">Sửa</a> 
						<!-- Modal -->
									...
									<div class="modal-body">
										<form:form action="/kienhtph17743/admin/update_user/${acc.id}"
											...
											<form:input type="text" path="fullname"
												class="form-control mt-2 formstyle" placeholder="Họ và Tên" value="${acc.fullname}"/>
											<form:input type="text" path="email"
												class="form-control mt-2 formstyle" placeholder="Email" value="${acc.email}" />
											...
											<form:input type="file" path="photo"
												class="form-control mt-2" placeholder="avatar" value="${acc.photo}" />
											<div>
